...
parser=optparse.OptionParser(usage='%prog --template filename1 filename2',version='%prog 1.2',epilog="Report any bugs to lichun.william@gmail.com", prog='plhck')
parser.add_option("-t","--template"   ,action="store",type="string",dest="template",help="the template")
parser.add_option("-i","--hostname-to-ip"   ,action="store_true",default=False,dest="to_ip",help="change host  name to ip address")
